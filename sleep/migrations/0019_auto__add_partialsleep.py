...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartialSleep'
        db.create_table('sleep_partialsleep', (
        ...
        db.send_create_signal('sleep', ['PartialSleep'])


    def backwards(self, orm):
        # Deleting model 'PartialSleep'
        db.delete_table('sleep_partialsleep')
