...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.punchInDelay'
        db.add_column('sleep_sleeperprofile', 'punchInDelay',
                      self.gf('django.db.models.fields.DecimalField')(default=15, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.punchInDelay'
        db.delete_column('sleep_sleeperprofile', 'punchInDelay')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 17, 0, 0)'}),
