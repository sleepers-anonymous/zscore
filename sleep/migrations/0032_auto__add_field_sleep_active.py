...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sleep.active'
        db.add_column('sleep_sleep', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sleep.active'
        db.delete_column('sleep_sleep', 'active')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
