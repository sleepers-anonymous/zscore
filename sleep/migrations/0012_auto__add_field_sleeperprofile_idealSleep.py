...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.idealSleep'
        db.add_column('sleep_sleeperprofile', 'idealSleep',
                      self.gf('django.db.models.fields.DecimalField')(default=7.5, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.idealSleep'
        db.delete_column('sleep_sleeperprofile', 'idealSleep')
