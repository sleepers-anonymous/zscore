...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sleep_grouprequest', (
        ...
        db.send_create_signal('sleep', ['GroupRequest'])


    def backwards(self, orm):
        # Deleting model 'GroupRequest'
        db.delete_table('sleep_grouprequest')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
