...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Metric'
        db.create_table('sleep_metric', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('display_style', self.gf('django.db.models.fields.CharField')(default='asHHMM', max_length=6)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('show_by_default', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('sleep', ['Metric'])

    def backwards(self, orm):
        
        # Deleting model 'Metric'
        db.delete_table('sleep_metric')
