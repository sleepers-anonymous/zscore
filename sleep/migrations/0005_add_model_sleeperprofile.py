...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SleeperProfile'
        db.create_table('sleep_sleeperprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('privacy', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('use12HourTime', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sleep', ['SleeperProfile'])


    def backwards(self, orm):
        # Deleting model 'SleeperProfile'
        db.delete_table('sleep_sleeperprofile')
