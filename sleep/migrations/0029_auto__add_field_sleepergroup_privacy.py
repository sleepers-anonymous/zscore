...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperGroup.privacy'
        db.add_column('sleep_sleepergroup', 'privacy',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperGroup.privacy'
        db.delete_column('sleep_sleepergroup', 'privacy')
