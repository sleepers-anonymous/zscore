...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field metrics on 'SleeperProfile'
        db.create_table('sleep_sleeperprofile_metrics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sleeperprofile', models.ForeignKey(orm['sleep.sleeperprofile'], null=False)),
            ('metric', models.ForeignKey(orm['sleep.metric'], null=False))
        ))
        db.create_unique('sleep_sleeperprofile_metrics', ['sleeperprofile_id', 'metric_id'])

    def backwards(self, orm):
        
        # Removing M2M table for field metrics on 'SleeperProfile'
        db.delete_table('sleep_sleeperprofile_metrics')
