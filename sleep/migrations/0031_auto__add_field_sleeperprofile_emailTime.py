...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.emailTime'
        db.add_column('sleep_sleeperprofile', 'emailTime',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(12, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.emailTime'
        db.delete_column('sleep_sleeperprofile', 'emailTime')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 8, 0, 0)'}),
