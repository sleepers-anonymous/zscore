...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sleep_membership', (
        ...
        db.send_create_signal('sleep', ['Membership'])

        # Adding model 'SleeperGroup'
        db.create_table('sleep_sleepergroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('sleep', ['SleeperGroup'])


    def backwards(self, orm):
        # Deleting model 'Membership'
        db.delete_table('sleep_membership')

        # Deleting model 'SleeperGroup'
        db.delete_table('sleep_sleepergroup')
