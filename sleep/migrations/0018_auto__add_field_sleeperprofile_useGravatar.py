...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.useGravatar'
        db.add_column('sleep_sleeperprofile', 'useGravatar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.useGravatar'
        db.delete_column('sleep_sleeperprofile', 'useGravatar')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'useGravatar': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
