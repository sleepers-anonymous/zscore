...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.mobile'
        db.add_column('sleep_sleeperprofile', 'mobile',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.mobile'
        db.delete_column('sleep_sleeperprofile', 'mobile')
