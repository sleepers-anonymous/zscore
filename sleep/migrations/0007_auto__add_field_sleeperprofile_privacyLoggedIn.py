...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.privacyLoggedIn'
        db.add_column('sleep_sleeperprofile', 'privacyLoggedIn',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.privacyLoggedIn'
        db.delete_column('sleep_sleeperprofile', 'privacyLoggedIn')
