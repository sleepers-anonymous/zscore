...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.timezone'
        db.add_column('sleep_sleeperprofile', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='US/Eastern', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.timezone'
        db.delete_column('sleep_sleeperprofile', 'timezone')
