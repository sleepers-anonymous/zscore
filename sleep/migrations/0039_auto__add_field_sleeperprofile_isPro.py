...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.isPro'
        db.add_column('sleep_sleeperprofile', 'isPro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.isPro'
        db.delete_column('sleep_sleeperprofile', 'isPro')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)'}),
