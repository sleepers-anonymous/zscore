...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.goodOrBad'
        db.add_column('sleep_sleeperprofile', 'goodOrBad',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.goodOrBad'
        db.delete_column('sleep_sleeperprofile', 'goodOrBad')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 24, 0, 0)'}),
