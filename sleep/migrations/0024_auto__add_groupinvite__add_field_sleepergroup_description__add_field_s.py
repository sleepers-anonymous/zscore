...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupInvite'
        db.create_table('sleep_groupinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sleep.SleeperGroup'])),
            ('accepted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('sleep', ['GroupInvite'])

        # Adding field 'SleeperGroup.description'
        db.add_column('sleep_sleepergroup', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SleeperProfile.autoAcceptGroups'
        db.add_column('sleep_sleeperprofile', 'autoAcceptGroups',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GroupInvite'
        db.delete_table('sleep_groupinvite')

        # Deleting field 'SleeperGroup.description'
        db.delete_column('sleep_sleepergroup', 'description')

        # Deleting field 'SleeperProfile.autoAcceptGroups'
        db.delete_column('sleep_sleeperprofile', 'autoAcceptGroups')
