...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.emailreminders'
        db.add_column('sleep_sleeperprofile', 'emailreminders',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.emailreminders'
        db.delete_column('sleep_sleeperprofile', 'emailreminders')
