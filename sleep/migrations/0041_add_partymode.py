...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SleeperProfile.partyMode'
        db.add_column('sleep_sleeperprofile', 'partyMode',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SleeperProfile.partyMode'
        db.delete_column('sleep_sleeperprofile', 'partyMode')
    ...
    models = {
        ...
        'sleep.sleeperprofile': {
            ...
            'emailSHA1GenerationDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
            ...
            'partyMode': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'privacy': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
