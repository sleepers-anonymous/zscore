...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sleep.timezone'
        db.add_column('sleep_sleep', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='America/New_York', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sleep.timezone'
        db.delete_column('sleep_sleep', 'timezone')
