...
urlpatterns = patterns('',
    ...
    url(r'^leaderboard/(\w+)/$', 'sleep.views.leaderboardLegacy'),
    ...
    url(r'^graph/$', 'sleep.views.graph'),
    url(r'^editprofile/$', 'sleep.views.editProfile'),
    url(r'^creep/$', 'sleep.views.creep'),
    url(r'^creep/([^/]*)/$', 'sleep.views.creep'),
    url(r'^creep/([^/]*)/?as=(?P<asOther>[^/]*)/$', 'sleep.views.creep'),
    url(r'^creep/([^/]*)/?type=(?P<type>[^/]*)/$', 'sleep.views.creep'),
